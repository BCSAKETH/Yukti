...
def create_ppt():
    ...
    # 2. Abstract
    add_slide("Abstract", [
        "Yukti is an immersive, AI-first simulation platform designed to bridge the gap between theoretical social entrepreneurship and real-world execution."
    ])
    ...
    prs.save('Yukti_Presentation.pptx')
