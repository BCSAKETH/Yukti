        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div className="space-y-10">
            ...
            >
              <button 
                onClick={signIn}
                className="w-full sm:w-auto bg-teal-600 text-white px-10 py-5 rounded-2xl font-black text-xs uppercase tracking-[0.3em] shadow-[0_20px_40px_rgba(13,148,136,0.3)] hover:bg-teal-500 hover:-translate-y-1 active:scale-95 transition-all flex items-center justify-center gap-4 group"
              >
                Access Platform <ArrowRight size={18} className="group-hover:translate-x-2 transition-transform" />
              </button>
              <button className="w-full sm:w-auto bg-white/40 backdrop-blur-md border border-white/60 text-slate-600 px-10 py-5 rounded-2xl font-black text-xs uppercase tracking-[0.3em] hover:bg-white/60 transition-all">
                The Methodology
              </button>
            </motion.div>
          </div>
    ...
    <div className="relative rounded-[2.5rem] overflow-hidden aspect-[16/10] bg-slate-100 group">
       <AnimatePresence mode="wait">
          ...
          >
             ...
             <img 
               src={active === 0 ? "/social_engine_preview.png" : active === 1 ? "/policy_lab_preview.png" : "/execution_hub_preview.png"} 
